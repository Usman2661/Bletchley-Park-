...
public class hut8 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    private Button scanbutton;

    Context ctx=this;

    public static final String API_KEY = "AIzaSyA_myUPH7acHdgvsT59PhjVdlwARUVGCDw";
    public static final String VIDEO_ID = "mEA8lANgPLE";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanPage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                Intent intent= new Intent(hut8.this,scanItems.class);
