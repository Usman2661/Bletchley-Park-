...
public class mansionPage extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    private Button scanbutton;

    public static final String API_KEY = "AIzaSyA_myUPH7acHdgvsT59PhjVdlwARUVGCDw";
    public static final String VIDEO_ID = "U1UlNMQ5XPs";
    Context ctx=this;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mansion_page);

        Button scanPage=(Button) findViewById(R.id.scanItems);
        scanPage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                Intent intent= new Intent(mansionPage.this,scanItems.class);
